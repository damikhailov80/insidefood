...
import { PhotoMainStep } from "@/components/add-product/PhotoMainStep";
import { RecognitionStep } from "@/components/add-product/RecognitionStep";
import { ConfirmBasicInfoStep } from "@/components/add-product/ConfirmBasicInfoStep";
import { DetailsStep } from "@/components/add-product/DetailsStep";

type Step = "photoMain" | "recognition" | "confirmation" | "details";

export default function AddProductScreen() {
  const { barcode } = useLocalSearchParams<{ barcode: string }>();
  const router = useRouter();

  const [currentStep, setCurrentStep] = useState<Step>("photoMain");
